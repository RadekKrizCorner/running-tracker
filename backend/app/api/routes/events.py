...
def post_event(payload: EventCreate, session: DbSession, user: WritableUser) -> EventRead:
...
def patch_event(event_id: UUID, payload: EventUpdate, session: DbSession, user: WritableUser) -> EventRead:
...
def remove_event(event_id: UUID, session: DbSession, user: WritableUser) -> Response:
