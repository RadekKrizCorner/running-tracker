...
def render_report_svg(values: dict[str, Any], template: dict[str, Any] | None = None) -> str:
  ...
  <defs>
    ...
    <style>
      ...
      .title {{ fill: {theme["text"]}; font-size: 62px; font-weight: 900; }}
  ...
  <rect x="250" y="1587" width="610" height="32" rx="16" fill="{theme["stroke"]}"/>
  <rect x="250" y="1587" width="{actual_width}" height="32" rx="16" fill="{theme["primary"]}"/>
